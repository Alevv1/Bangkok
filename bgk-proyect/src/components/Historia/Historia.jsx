...
function historia() {
  return (
    <section className={styles.container}>
            <div className={styles.title} id='historia'>Historia</div>
            <div className={styles.content}>
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Fuga nisi iure nostrum incidunt consequuntur, eos veniam, ipsam libero at quibusdam nam deserunt ea nobis ab, porro explicabo quo facere quaerat.
